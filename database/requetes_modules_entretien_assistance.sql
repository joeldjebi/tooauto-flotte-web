...
('articles', 'Articles', 'Opérations', 50, NOW(), NOW()),
('entretiens', 'Entretien', 'Services flotte', 60, NOW(), NOW()),
('assistances', 'Assistance', 'Services flotte', 70, NOW(), NOW()),
('reparations', 'Réparations & Suivi', 'Services flotte', 80, NOW(), NOW()),
('carburants', 'Carburant & Conso.', 'Services flotte', 90, NOW(), NOW()),
('alertes', 'Toutes les alertes', 'Alertes', 100, NOW(), NOW()),
('alerte_assurance', 'Assurance', 'Alertes', 110, NOW(), NOW()),
('alerte_vidange', 'Vidange', 'Alertes', 120, NOW(), NOW()),
('alerte_visite', 'Visite technique', 'Alertes', 130, NOW(), NOW()),
('alerte_controle', 'Contrôle technique', 'Alertes', 140, NOW(), NOW()),
('prestataires', 'Prestataires', 'Réseau', 150, NOW(), NOW()),
('concessionnaires', 'Concessionnaires', 'Réseau', 160, NOW(), NOW()),
('offres', 'Offres', 'Réseau', 170, NOW(), NOW()),
('demandes_concessionnaires', 'Demandes concessionnaires', 'Réseau', 180, NOW(), NOW()),
('annonces_envoyees', 'Annonces envoyées', 'Réseau', 190, NOW(), NOW()),
('fonctions', 'Fonctions', 'Utilisateurs', 200, NOW(), NOW()),
('roles', 'Rôles & permissions', 'Utilisateurs', 210, NOW(), NOW()),
('admin_users', 'Users admin', 'Utilisateurs', 220, NOW(), NOW()),
('utilisateurs', 'Chauffeurs', 'Utilisateurs', 230, NOW(), NOW()),
('profil', 'Mon profil', 'Paramètres', 240, NOW(), NOW()),
('password', 'Mot de passe', 'Paramètres', 250, NOW(), NOW()),
('documentation', 'Documentation', 'Aide', 260, NOW(), NOW())
